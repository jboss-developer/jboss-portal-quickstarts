...
This release of Portal Quickstarts is compatible with GateIn Portal ${compatibility.gatein.version}. There is no support for JBoss Enterprise Portal 
Platform (EPP) yet, but the included example projects will evolve to support the coming EPP version ${compatibility.epp.version}.
